...
# Development
To setup the server locally, setup dependencies then setup the server. Follow this guide: [View Development Wiki](https://github.com/enjalot/building-blocks/wiki/Development#development)
